...
export const SEND_FORGOT_PASSWORD_EMAIL_REQUEST = 'SEND_EMAIL_REQUEST';
export const SEND_FORGOT_PASSWORD_EMAIL_SUCCESS = 'SEND_EMAIL_SUCCESS';
export const SEND_FORGOT_PASSWORD_EMAIL_ERROR = 'SEND_EMAIL_ERROR';
